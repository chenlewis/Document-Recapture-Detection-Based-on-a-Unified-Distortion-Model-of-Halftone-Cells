classdef halftoneDataAnalyzerCam
...
%     halfoneMeanWidthEdges = 1;
  ...
  methods
    ...
    function obj = halftoneDataAnalyzerCam(baselineDataCollectionPath, testImageDataCollectionPath, testImgType)
      ...
      for i = 1:obj.numBaselineImageBlks
        if ~isempty(obj.sampleSigmaABaselineCell{i}) 
          if obj.optSigmaABaselineCell{i} ~= 0
            ...
            if intensityBaseline == 230 || intensityBaseline == 50
              continue;
            end
            ...
            if length(separatorIdxBaseline{i}) == 4     % without rot
              blockIdx = str2double(obj.filenameCollectionBaseline{i}...
                                   ((separatorIdxBaseline{i}(4) + 1):(extIdxBaseline{i}(2) - 1)));
              sampleSigmaABaselineArray(8) = 0;
              sampleHalftoneWidthBaselineArray(7) = 0;
            elseif length(separatorIdxBaseline{i}) == 5 % with rot
              blockIdx = str2double(obj.filenameCollectionBaseline{i}...
                                   ((separatorIdxBaseline{i}(4) + 1):(separatorIdxBaseline{i}(5) - 1)));
